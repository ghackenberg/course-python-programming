...
\begin{frame}{Learning Objectives}
    \begin{itemize}
        \item Store collections of data in lists.
        \item Understand the immutability of tuples.
        \item Use dictionaries to store key-value pairs.
        \item Choose the right data structure for a given problem.
    \end{itemize}
\end{frame}
